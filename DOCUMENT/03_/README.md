...
|-|-|
|-|-|
|Serial.begin(unsigned long baudrate);|	시리얼 통신을 초기화하는 함수<br>
	baudrate : 통신 속도를 나타내는 매개변수로, 통신할 장치 간의 데이터 전송 속도를 설정<br>
	일반적으로 사용되는 값은 300, 1200, 2400, 4800, 9600, 14400, 19200, 28800, 38400, 57600, 또는 115200<br>
	이 값은 비트 속도 (bps, bits per second)를 나타냅니다.|
|-|-|
|-|-|
|-|-|
|-|-|
